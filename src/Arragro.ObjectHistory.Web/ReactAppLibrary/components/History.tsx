...
type ComponentPropeties = Services.ObjectHistoryConnectedState & Services.ObjectHistoryConnectedDispatch & IHistoryPageProps
...
class History extends React.Component<ComponentPropeties> {
    ...
    componentDidMount () {
        this.handleUrlParams(this.props.objectName)
    }

    componentWillReceiveProps (nextProps: ComponentPropeties) {
        if (nextProps.objectName !== this.props.objectName) {
            this.handleUrlParams(nextProps.objectName)
        }
    }
